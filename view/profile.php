         ...
         <form action="recherche.php" method="POST" >
                    <span>
                        <div class="filtre_ic">
                         ...
                         <br><br><br><br>
<a class="course_button_v2" href="FRONT.php"><i>Revenir à la page d'acceuil</i></a>
                    </span>
 </form>
                                ...
                                <div class="instructor-profile_courses_list">
                                    ...
                                    <div class="course_align">
                                        ...
                                        <div class="course_button">
                                            <!--show button -->
                                            <a class="course_button_v2" href="profile2.php?id=<?php echo $cours['id_cours'];?>"><i class="fal fa-eye"></i></a>
